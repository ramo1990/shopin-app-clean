...
const SearchButton = ({handleSearch, showSearchForm}: Props) => {
  return (
    <button 
        ...
        className="w-[30px] h-[30px] rounded-full bg-black text-white flex items-center justify-center transition hover:opacity-80 focus:ring-2 focus:ring-offset-2 focus:ring-black">
